...
Data_LT_SC_C_NoNA <- Data_LT_SC_C_NoNA[complete.cases(RawData_LT_SC_Char$ft_lt_conservatives),]
Data_LT_SC_C_NoNA <- Data_LT_SC_C_NoNA[complete.cases(RawData_LT_SC_Char$income_group_lt),]
Data_LT_SC_C_NoNA$party_indentification <- (complete.cases(RawData_LT_SC_Char$party_indentification))
...
Data_LT_SC_C_NoNA$ift_lt_big_business <- as.numeric(Data_LT_SC_C_NoNA$ft_lt_big_business)
