...
ggplot(data = RawData_SC) +
  ...
  coord_cartesian(ylim = c(-10,110)) +
  labs(
    title = "Biden vs Journalists Thermometers",
    subtitle = "Factored via Sex",
    x = "Biden",
    y = "Journalists",
    caption = "Data via ANES",
...
ra_plot <- ggplot(data = RawData_SC) +
  aes(x =who_for_president, y = ft_rural_americans, fill=who_for_president) +
...
fem_plot <- ggplot(data = RawData_SC) +
  aes(x =who_for_president, y = ft_fauci, fill=who_for_president) +
  geom_bar(stat = "summary", width=1, color="gray1", position = 'dodge') +
  scale_x_discrete(limits=c("Biden", "Trump")) +
  scale_y_continuous(limits=c(0, 100)) +
  scale_fill_manual(values =  c("Biden" = "blue",  "Trump" = "red")) +
...
mus_plot <- ggplot(data = RawData_SC) +
  aes(x =who_for_president, y = ft_muslims, fill=who_for_president) +
  geom_bar(stat = "summary", width=1, color="gray1", position = 'dodge') +
  scale_x_discrete(limits=c("Biden", "Trump")) +
  scale_y_continuous(limits=c(0, 100)) +
  scale_fill_manual(values =  c("Biden" = "blue",  "Trump" = "red")) +
...
me_too_plot <- ggplot(data = RawData_SC) +
  aes(x =who_for_president, y = ft_me_too, fill=who_for_president) +
  geom_bar(stat = "summary", width=1, color="gray1", position = 'dodge') +
  scale_x_discrete(limits=c("Biden", "Trump")) +
  scale_y_continuous(limits=c(0, 100)) +
  scale_fill_manual(values =  c("Biden" = "blue",  "Trump" = "red")) +
...
```{r}
library(ggplot2)
figure1 <- ggarrange(ra_plot, fem_plot, mus_plot, me_too_plot) 

 annotate_figure(figure1,
               top = text_grob("Feeling Thermometer - Dissagreements by Presidential Vote", color = "firebrick4", face = "bold", size = 14),
               bottom = text_grob("Data source: ANES", color = "grey5",
                                  hjust = 1, x = 1, face = "italic", size = 10),
               left = text_grob("Feeling Thermometer 0-100", color = "grey5", rot = 90))
...
```{r}
library(ggplot2)
figure2 <- ggarrange(con_plot, bus_plot) 

 annotate_figure(figure2,
               top = text_grob("Feeling Thermometer - Somewhat Agreements by Presidential Vote", color = "firebrick4", face = "bold", size = 14),
               bottom = text_grob("Data source: ANES", color = "grey5",
                                  hjust = 1, x = 1, face = "italic", size = 10),
               left = text_grob("Feeling Thermometer 0-100", color = "grey5", rot = 90))
...
```{r}
library(ggplot2)
figure3 <- ggarrange(fox_plot, nyt_plot) 

 annotate_figure(figure3,
               top = text_grob("News Sources By Presidential Vote", color = "firebrick4", face = "bold", size = 14),
               bottom = text_grob("Data source: ANES", color = "grey5",
                                  hjust = 1, x = 1, face = "italic", size = 10),
